...
if __name__ == '__main__':
    ...
    #  Fill agent.memory with your dataset
    ...
    #  Plot and save the offline learning curve
...
with open('pendulum_offline_scores.pkl', 'wb') as f:
    pickle.dump(list(zip(eval_steps, eval_scores)), f)
print(" Saved offline evaluation scores to 'pendulum_offline_scores.pkl'")
