...
if __name__ == '__main__':
    ...
    n_games = 300  # <- reduce for quick test or increase for convergence
    filename = f'{env_id}_{n_games}games_scale{agent.scale}_clamp_on_sigma.png'
    ...
    for i in range(n_games):
        ...
        print(f'episode {i} | score {score:.1f} | trailing 100 avg {avg_score:.1f} | steps {steps} | {env_id}')
